window.QUESTIONS_MODULES = {
    ...
    // Configuration volontairement courte des autres modules pour alléger le copier-coller
    "Habilitation Électrique": [
        { q: "Quelle est la différence entre électrisation et électrocution ?", o: ["A) L'électrisation est mortelle", "B) L'électrocution entraîne le décès", "C) C'est la même chose"], r: "B" },
        { q: "Que signifie le sigle VAT en sécurité électrique ?", o: ["A) Vérification de l'Absence de Tension", "B) Voltage Automatique", "C) Assistance Technique"], r: "A" }
    ],
...
// Sécurisation : Cloner automatiquement les questions pour éviter que le site ne plante sur les modules vides
["Corde & Sauvetage", "Assemblage au Mât", "Élingage", "Conduite Défensive", "Opérateur de Machines"].forEach(mod => {
    window.QUESTIONS_MODULES[mod] = [...window.QUESTIONS_MODULES["Habilitation Électrique"]];
});
